...
public abstract class ModuleLayoutManager extends RecyclerView.LayoutManager implements
    ...
    private Rect calculateViewSizeByPosition(View child, int position) {
        ...
        if (lastPos == 0) {
            ...
            leftOffset = (getItemLeftOffsetWidth(position) + getChildHorizontalPadding(child)) * 1
                    - mDecorInsets.left;
        }
        ...
        if (topPos == 0) {
            ...
            topOffset = (getItemTopOffsetWidth(position) + getChildVerticalPadding(child)) * 1
                    - mDecorInsets.top;
        }
    ...
    protected abstract int getItemTopOffsetWidth(int position);

    protected abstract int getItemLeftOffsetWidth(int position);
